...
namespace DataBase_Wizard {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class empDataTable : global::System.Data.TypedTableBase<empRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public empRow AddempRow(string Name, string Address, int Number) {
        ...
        public partial class empRow : global::System.Data.DataRow {
            ...
            public int Number {
                get {
                    try {
                        return ((int)(this[this.tableemp.NumberColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Number\' in table \'emp\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableemp.NumberColumn] = value;
                }
            }
            ...
            public bool IsNumberNull() {
                return this.IsNull(this.tableemp.NumberColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public void SetNumberNull() {
                this[this.tableemp.NumberColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace DataBase_Wizard.Database1DataSetTableAdapters {
    ...
    public partial class empTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `emp` WHERE ((`ID` = ?) AND ((? = 1 AND `Name` IS NULL) OR (`Name` = " +
                "?)) AND ((? = 1 AND `Address` IS NULL) OR (`Address` = ?)) AND ((? = 1 AND `Numb" +
                "er` IS NULL) OR (`Number` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `emp` (`Name`, `Address`, `Number`) VALUES (?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `emp` SET `Name` = ?, `Address` = ?, `Number` = ? WHERE ((`ID` = ?) AND ((" +
                "? = 1 AND `Name` IS NULL) OR (`Name` = ?)) AND ((? = 1 AND `Address` IS NULL) OR" +
                " (`Address` = ?)) AND ((? = 1 AND `Number` IS NULL) OR (`Number` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DataBase_Wizard.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, Address, [Number] FROM emp";
        ...
        public virtual int Delete(int Original_ID, string Original_Name, string Original_Address, global::System.Nullable<int> Original_Number) {
        ...
        public virtual int Insert(string Name, string Address, global::System.Nullable<int> Number) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Address, global::System.Nullable<int> Number, int Original_ID, string Original_Name, string Original_Address, global::System.Nullable<int> Original_Number) {
            if ((Name == null)) {
